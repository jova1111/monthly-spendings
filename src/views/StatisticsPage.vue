<template>
  <div class="main-container" v-if="isLoaded">
    ...
    <div class="general-statistics">
      <h4>
        Total spendings in this period: {{ totalSpendings | numberWithCommas }}
      </h4>
    </div>

    <div
      v-if="statisticsYear == 'All time'"
      class="center-middle chart-container"
    >
      <h2>Total monthly spendings by years</h2>
      <chart
        class="center-middle"
        :chart-data="spendingsGroupedByMonthByAllYearsChartData"
      ></chart>
    </div>
    ...
    <div class="center-middle chart-container">
      ...
      <chart
        class="center-middle"
        :chart-data="spendingsGroupedByMonthChartData"
      ></chart>
    </div>
    ...
    <div class="center-middle chart-container">
      ...
      <chart
        class="center-middle"
        :chart-data="spendingsGroupedByCategoryAndMonthChartData"
      ></chart>
    </div>
...
export default {
  ...
  computed: {
    totalSpendings: function () {
      return this.allTransactionsForYear.reduce(
    ...
    spendingsGroupedByCategoryAndMonthChartData: function () {
      ...
      for (let categorySpendings of this.spendingsGroupedByCategoryAndMonth) {
        ...
        for (let i = 0; i < categorySpendings[categoryName].length; i++) {
          monthlySpending[categorySpendings[categoryName][i].month] =
            categorySpendings[categoryName][i].total;
        }
    ...
    spendingsGroupedByMonthByAllYearsChartData: function () {
      let retVal = {};
      for (let yearlySpendings of this.spendingsGroupedByMonthByAllYears) {
        let monthlySpendings = {};
        yearlySpendings.monthly_spendings.forEach((monthlySpending) => {
          monthlySpendings[monthlySpending.month] = monthlySpending.total;
        });
        retVal[yearlySpendings.year] = monthlySpendings;
      }
      return retVal;
    },
  },
  ...
  data() {
    return {
      ...
      spendingsGroupedByMonthByAllYears: {},
    };
  },
